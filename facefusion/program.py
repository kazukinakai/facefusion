...
def create_execution_program() -> ArgumentParser:
	...
	group_execution.add_argument('--tensorrt-fp16', help = translator.get('help.tensorrt_fp16'), action = BooleanOptionalAction, default = config.get_bool_value('execution', 'tensorrt_fp16', 'True'))
