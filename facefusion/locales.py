...
LOCALES : Locales =\
{
	'en':
	{
		...
		'job_optimized': 'job {job_id} optimized into {step_total} steps',
		'job_not_optimized': 'job {job_id} not optimized',
		...
		'help':
		{
			...
			'resume': 'split long videos into steps so an interrupted run can resume from the last completed step',
			...
			'job_optimize': 'split the steps of a drafted or queued job into smaller frame ranges for granular resume',
			'step_frame_total': 'number of frames per step when splitting a job',
