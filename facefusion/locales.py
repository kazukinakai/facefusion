...
LOCALES : Locales =\
{
	'en':
	{
		...
		'job_split': 'job {job_id} split into {step_total} steps',
		'job_not_split': 'job {job_id} not split',
		...
		'help':
		{
			...
			'resume': 'split long videos into resumable steps',
			...
			'tensorrt_fp16': 'enable fp16 for the tensorrt execution provider',
			...
			'job_split': 'split a drafted or queued job into smaller steps',
			'step_frame_total': 'specify the number of frames per step',
		...
		'uis':
		{
			...
			'execution_tensorrt_fp16_checkbox': 'TENSORRT FP16',
